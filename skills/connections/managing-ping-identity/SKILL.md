...
description: |
  Ping Identity platform management for SSO configuration, MFA policy review, directory bridge monitoring, session management, and environment health checks. Covers PingOne, PingFederate, and PingAccess administration. Read this skill before any Ping Identity operations — it enforces discovery-first patterns and strict read-only safety rules.
