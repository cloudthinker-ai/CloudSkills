...
description: |
  Use when working with Jaeger — jaeger distributed tracing for trace search,
  service dependency analysis, span analysis, sampling configuration, and
  performance monitoring. Covers trace lookup, service topology, operation
  latency analysis, and comparison workflows. Use when searching traces,
  analyzing service dependencies, investigating latency, or managing Jaeger
