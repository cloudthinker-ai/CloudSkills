...
name: managing-drata
description: |
  Drata compliance automation platform for SOC 2, ISO 27001, HIPAA, PCI DSS, and GDPR compliance monitoring. Covers control monitoring, evidence collection, personnel management, asset tracking, and audit readiness. Use when reviewing compliance posture, checking control status, tracking evidence collection, managing personnel compliance, or preparing for security audits.
