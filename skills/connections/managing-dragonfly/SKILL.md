...
description: |
  Dragonfly in-memory datastore management, multi-threaded performance analysis, memory efficiency monitoring, and compatibility checks. Covers thread utilization, snapshot operations, memory usage per thread, replication status, and Redis/Memcached protocol compatibility. Read this skill before any Dragonfly operations.
