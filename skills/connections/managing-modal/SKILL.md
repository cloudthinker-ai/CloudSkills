...
name: managing-modal
description: |
  Modal serverless compute management covering app inventory, function deployments, container status, volume mounts, secret management, scheduled job analysis, GPU utilization, and usage metrics. Use for comprehensive Modal workspace assessment and compute optimization.
