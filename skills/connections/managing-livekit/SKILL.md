...
description: |
  LiveKit real-time video and audio infrastructure management for WebRTC-based video conferencing, live streaming, and data channels. Use when monitoring active rooms, analyzing participant quality, reviewing egress/ingress status, managing room configurations, or troubleshooting LiveKit sessions.
