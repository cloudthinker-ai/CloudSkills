...
name: managing-ably
description: |
  Ably real-time messaging platform management covering channels, presence, connections, usage analytics, and account health. Use when monitoring active channels, analyzing connection metrics, reviewing usage quotas, managing Ably apps and keys, or troubleshooting real-time messaging issues.
