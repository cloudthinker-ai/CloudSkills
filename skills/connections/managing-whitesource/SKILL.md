...
description: |
  Mend (formerly WhiteSource) software composition analysis for open-source security, license compliance, and automated remediation. Covers vulnerability detection, library inventory, policy violations, fix recommendations, and project health tracking. Use when reviewing open-source vulnerabilities, analyzing dependency risks, managing license compliance, or tracking remediation progress across projects.
