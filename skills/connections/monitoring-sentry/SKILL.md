...
description: |
  Use when working with Sentry — sentry error tracking, performance monitoring,
  release health, and issue management. Covers error investigation, stack trace
  analysis, release comparison, performance transaction monitoring, alert rule
  management, and issue triage workflows. Use when investigating application
  errors, analyzing crash rates, reviewing release health, or managing Sentry
  projects.
