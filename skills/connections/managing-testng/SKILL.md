...
description: |
  TestNG testing framework management and analysis. Covers test suite XML configuration, group-based execution, data provider analysis, parallel execution settings, report parsing, and listener configuration. Use when managing TestNG suites, investigating test failures, or reviewing Java test configurations with TestNG features.
