...
name: managing-caddy
description: |
  Caddy web server management, automatic TLS certificate handling, reverse proxy configuration, site management, and plugin inspection. Covers Caddyfile analysis, admin API usage, access logs, and upstream health monitoring. Read this skill before any Caddy operations — it enforces discovery-first patterns, anti-hallucination rules, and safety constraints.
