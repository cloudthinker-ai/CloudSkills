...
description: |
  Use when working with Pulsar — apache Pulsar tenant management, namespace
  policies, topic statistics, subscription lag, and cluster health.
