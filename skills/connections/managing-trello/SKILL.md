...
description: |
  Trello board management covering boards, lists, cards, members, labels, and activity analytics. Use when auditing Trello usage, managing boards and cards, analyzing workflow bottlenecks, or reviewing team activity across Trello workspaces.
