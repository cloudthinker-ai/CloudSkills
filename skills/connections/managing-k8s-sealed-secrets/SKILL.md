...
description: |
  Sealed Secrets management for Kubernetes secret encryption. Covers SealedSecret resources, controller health, certificate rotation, key management, decryption status, and secret synchronization. Use when auditing encrypted secrets, debugging decryption failures, reviewing key rotation, or troubleshooting SealedSecret controller issues.
connection_type: k8s
preload: false
---
