...
description: |
  Use when working with Statsig — statsig feature gate management, dynamic
  configs, experiment analysis, and metric tracking. Covers gate configuration,
  rule-based targeting, holdout groups, A/B test results, pulse metrics, and
  layer management. Use when managing feature gates, reviewing experiment
  results, analyzing metric lifts, or configuring dynamic configs in Statsig.
