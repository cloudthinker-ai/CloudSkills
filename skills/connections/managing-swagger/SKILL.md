...
description: |
  Use when working with Swagger — swagger and OpenAPI specification management -
  spec validation, code generation, Swagger UI management, and schema analysis.
  Use when validating API specifications, generating client/server code from
  OpenAPI specs, managing Swagger UI deployments, or analyzing API schema
  structures.
