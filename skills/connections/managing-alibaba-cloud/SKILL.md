...
description: |
  Alibaba Cloud infrastructure management via the aliyun CLI. Covers ECS instances, RDS databases, VPCs, SLB load balancers, OSS storage, and billing. Use when managing Alibaba Cloud resources or checking infrastructure health.
