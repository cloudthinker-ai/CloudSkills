...
description: |
  SigNoz open-source observability platform for metrics, traces, and logs with OpenTelemetry-native ingestion. Covers service performance monitoring, trace analysis, log querying, dashboard management, and alert rule configuration. Use when querying SigNoz metrics, analyzing distributed traces, searching logs, or managing alert rules and dashboards.
