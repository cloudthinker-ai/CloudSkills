...
description: |
  External Secrets Operator management. Covers secret syncing from external providers, SecretStore configuration, ExternalSecret resource management, push secrets, ClusterSecretStore setup, and provider troubleshooting. Use when managing secret synchronization between external vaults and Kubernetes, debugging sync failures, or configuring secret providers.
