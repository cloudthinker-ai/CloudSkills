...
description: |
  Use when working with Pagerduty — pagerDuty incident management, alerting,
  escalation policies, on-call scheduling, and service management. Covers
  incident creation and lifecycle, on-call rotation queries, alert routing,
  analytics, postmortem tracking, and service health. Use when investigating
  active incidents, reviewing on-call schedules, analyzing incident trends, or
  managing PagerDuty services.
