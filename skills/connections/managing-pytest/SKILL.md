...
description: |
  Use when working with Pytest — pytest testing framework management and
  analysis. Covers test discovery, fixture analysis, coverage reporting,
  marker-based filtering, parametrized test review, plugin management, and
  conftest configuration. Use when managing pytest suites, investigating test
  failures, reviewing code coverage, or analyzing test performance.
