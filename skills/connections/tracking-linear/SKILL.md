...
description: |
  Linear project management for engineering teams. Covers issue tracking, sprint cycles, project roadmaps, team management, and workflow automation. Use when querying Linear issues, managing sprints, analyzing team velocity, searching for tickets, or creating/updating issues via the Linear GraphQL API.
