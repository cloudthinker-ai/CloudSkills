...
description: |
  Use when working with Playwright Deep — playwright end-to-end testing
  management and analysis. Covers test execution monitoring, trace analysis,
  browser context configuration, test report parsing, flaky test detection, and
  parallel execution tuning. Use when investigating test failures, analyzing
  test performance, or managing Playwright test suites.
