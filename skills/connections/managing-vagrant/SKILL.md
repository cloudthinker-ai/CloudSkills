...
description: |
  Use when working with Vagrant — vagrant development environment management.
  Covers box management, VM lifecycle, provisioner execution, multi-machine
  environments, snapshot management, and networking configuration. Use when
  managing Vagrant VMs, debugging provisioning failures, or inspecting
