...
description: |
  Use when working with Looker — looker BI platform management. Covers explore
  analysis, dashboard review, LookML project management, PDT status monitoring,
  query performance, user activity, and content validation. Use when analyzing
  dashboards, investigating query performance, managing LookML projects, or
  auditing Looker usage.
