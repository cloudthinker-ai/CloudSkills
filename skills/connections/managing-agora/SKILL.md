...
name: managing-agora
description: |
  Agora real-time engagement platform management for video/voice calling, interactive live streaming, and real-time messaging. Use when monitoring active channels, analyzing call quality metrics, reviewing usage statistics, managing projects, or troubleshooting Agora RTC sessions.
