...
description: |
  CockroachDB Cloud (Serverless & Dedicated) management via the ccloud CLI and CockroachDB Cloud API. Covers clusters, databases, SQL users, networking, backups, and metrics. Use when managing CockroachDB Cloud clusters or reviewing database health.
