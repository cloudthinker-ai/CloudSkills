...
description: |
  Advanced Stripe payment platform management including payment intents, subscriptions, invoices, disputes, payouts, Connect accounts, radar fraud rules, and billing portal. Covers revenue analytics, dispute rate monitoring, payout scheduling, and webhook health.
