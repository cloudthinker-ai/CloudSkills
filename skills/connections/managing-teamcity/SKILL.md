...
description: |
  Use when working with Teamcity — teamCity CI/CD server management. Covers
  build configurations, agent pools, VCS roots, build queue monitoring, project
  hierarchy, and build chain analysis. Use when checking build status,
  investigating failures, managing agents, or auditing TeamCity project
  configurations.
