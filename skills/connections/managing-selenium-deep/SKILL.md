...
description: |
  Selenium WebDriver testing management and grid monitoring. Covers Selenium Grid node health, session management, browser capability analysis, test result parsing, hub configuration review, and WebDriver compatibility checks. Use when managing Selenium Grid infrastructure, investigating test failures, or reviewing browser automation suites.
