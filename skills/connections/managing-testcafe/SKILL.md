...
description: |
  TestCafe end-to-end testing management and analysis. Covers test execution monitoring, browser provider configuration, concurrent test analysis, report parsing, fixture organization, and selector debugging. Use when managing TestCafe test suites, investigating failures, or reviewing test configurations.
