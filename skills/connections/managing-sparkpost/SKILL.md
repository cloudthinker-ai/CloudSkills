...
description: |
  SparkPost email delivery service management including sending domains, IP pools, message events, deliverability metrics, templates, webhooks, and suppression lists. Covers bounce classification, engagement tracking, and inbox placement analysis.
