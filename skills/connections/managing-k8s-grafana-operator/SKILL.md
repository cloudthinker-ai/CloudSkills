...
description: |
  Grafana Operator management for Kubernetes dashboard and datasource automation. Covers Grafana instances, GrafanaDashboard CRDs, GrafanaDatasource configurations, GrafanaFolder management, and operator health. Use when auditing dashboards, managing datasource configurations, debugging Grafana operator issues, or reviewing Grafana instance settings.
connection_type: k8s
preload: false
---
