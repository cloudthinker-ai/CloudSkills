...
name: managing-junit
description: |
  JUnit testing framework management and analysis. Covers test suite configuration, XML report parsing, test runner integration, assertion pattern review, parameterized test analysis, and build tool integration with Maven and Gradle. Use when managing JUnit test suites, investigating test failures, or reviewing Java/Kotlin test configurations.
