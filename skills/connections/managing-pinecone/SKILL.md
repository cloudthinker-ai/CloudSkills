...
description: |
  Pinecone vector database management, index health monitoring, namespace analysis, and query performance tuning. Covers index statistics, dimension configuration, pod utilization, collection management, and metadata filtering efficiency. Read this skill before any Pinecone operations.
