...
description: |
  Use when working with Rabbitmq — rabbitMQ queue management, exchange bindings,
  connection health, shovel and federation status, and cluster monitoring.
