...
description: |
  Fastly Compute@Edge service management covering service inventory, package deployments, backend health, domain mappings, VCL/Wasm configuration, real-time analytics, cache hit ratios, and edge dictionary inspection. Use for Fastly CDN and edge compute analysis.
