...
description: |
  AWS EFS file system management and performance analysis. Covers file system inventory, mount targets, access points, throughput modes, lifecycle policies, replication configurations, and storage metrics. Use when inspecting EFS file systems, debugging mount issues, reviewing performance settings, or optimizing storage costs.
connection_type: aws
preload: false
---
