...
description: |
  Calendly scheduling platform management covering event types, scheduled events, invitees, users, and booking analytics. Use when monitoring booking rates, analyzing event type performance, reviewing upcoming schedules, managing Calendly users and teams, or troubleshooting scheduling workflows.
