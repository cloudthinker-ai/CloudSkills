...
description: |
  Banana.dev ML inference platform management covering model inventory, deployment status, API call history, GPU allocation, scaling configuration, build logs, and latency metrics. Use for comprehensive Banana.dev model deployment assessment and inference performance analysis.
