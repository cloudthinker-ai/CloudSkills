...
name: managing-bind9
description: |
  BIND9 DNS server management covering zone files, named configuration, DNSSEC, RNDC controls, query logging, and server statistics. Use when managing BIND9 DNS servers, auditing zone configurations, troubleshooting DNS resolution, checking DNSSEC status, or monitoring BIND9 performance and query patterns.
