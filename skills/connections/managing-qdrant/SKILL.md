...
description: |
  Use when working with Qdrant — qdrant vector database management, collection
  health monitoring, shard distribution analysis, and query optimization. Covers
  collection configuration, HNSW index parameters, quantization settings,
  snapshot management, and cluster consensus state. Read this skill before any
  Qdrant operations.
