...
description: |
  Use when working with Typesense — typesense collection management, search
  tuning, schema analysis, and cluster health monitoring. Covers collection
  schemas, search analytics, synonym management, override rules, API key
  scoping, and curation configuration. Read this skill before any Typesense
  operations.
