...
name: managing-wandb
description: |
  Weights & Biases experiment tracking and ML ops management. Covers run tracking, sweep management, artifact versioning, report analysis, model registry, and team collaboration. Use when managing ML experiments, comparing training runs, analyzing hyperparameter sweeps, or auditing W&B project resources.
