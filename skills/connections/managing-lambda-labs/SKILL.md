...
description: |
  Lambda Labs GPU cloud management covering instance inventory, GPU type availability, SSH key management, filesystem status, instance pricing, and capacity analysis. Use for comprehensive Lambda Labs workspace assessment and GPU instance optimization.
