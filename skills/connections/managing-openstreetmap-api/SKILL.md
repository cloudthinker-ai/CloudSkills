...
description: |
  OpenStreetMap API and related services management including Nominatim geocoding, Overpass API queries, tile server health, changeset monitoring, and data quality checks. Covers API endpoint health, usage policy compliance, response latency, and data freshness monitoring.
