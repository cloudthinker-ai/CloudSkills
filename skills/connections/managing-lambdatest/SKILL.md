...
description: |
  LambdaTest cloud testing platform monitoring and analysis. Covers Selenium/Cypress test session management, tunnel monitoring, build tracking, screenshot testing, real-time testing status, and usage analytics. Use when managing LambdaTest sessions, reviewing cross-browser results, or monitoring cloud testing infrastructure.
