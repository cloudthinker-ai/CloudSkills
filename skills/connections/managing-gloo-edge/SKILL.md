...
description: |
  Gloo Edge API gateway management covering virtual services, upstreams, route tables, authentication policies, rate limiting, WAF, and transformation filters. Use when managing Gloo Edge gateway routing, configuring upstream discovery, debugging routing issues, setting up authentication, or analyzing API gateway performance.
