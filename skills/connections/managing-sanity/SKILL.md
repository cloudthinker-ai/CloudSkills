...
description: |
  Sanity.io headless CMS management covering dataset inventory, document type analysis, GROQ query monitoring, asset management, webhook tracking, and project member auditing. Use when reviewing content schemas, investigating query performance, monitoring content publishing, or auditing project access and API token usage.
