...
description: |
  Linode (Akamai Cloud) infrastructure management via the linode-cli. Covers Linodes, NodeBalancers, volumes, domains, databases, and Kubernetes (LKE). Use when managing Linode/Akamai resources or checking instance health.
