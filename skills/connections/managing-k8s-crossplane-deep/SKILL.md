...
description: |
  Crossplane deep-dive management for Kubernetes-native infrastructure provisioning. Covers provider health diagnostics, composition debugging, XRD schema validation, claim lifecycle analysis, managed resource drift detection, usage tracking, and EnvironmentConfig management. Use when debugging complex composition failures, analyzing cross-provider resource dependencies, or optimizing Crossplane performance.
connection_type: k8s
preload: false
---
