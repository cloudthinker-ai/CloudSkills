...
description: |
  Oracle Cloud Infrastructure management via the OCI CLI. Covers compute instances, networking, block storage, databases, and IAM. Use when managing Oracle Cloud resources, checking instance health, or reviewing OCI infrastructure.
