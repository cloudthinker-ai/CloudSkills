...
description: |
  Use when working with Axiom — axiom observability platform with dataset
  management, APL (Axiom Processing Language) queries, monitors, dashboards, and
  virtual fields. Covers log and event ingestion analysis, dataset statistics,
  alerting rules, annotation management, and data retention. Use when querying
  datasets with APL, managing monitors, analyzing ingestion volume, or reviewing
  dashboards via Axiom API.
