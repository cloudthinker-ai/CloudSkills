...
description: |
  Use when working with Travis Ci — travis CI build management and monitoring.
  Covers build history, repository settings, cron job management, cache
  administration, and environment variable configuration. Use when checking
  build status, investigating failures, managing cron schedules, or auditing
