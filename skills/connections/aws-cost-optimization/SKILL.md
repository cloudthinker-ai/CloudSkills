...
description: |
  Use when working with Aws Cost Optimization — aWS native cost optimization
  using Compute Optimizer, Trusted Advisor cost checks, Savings Plan analysis,
  Cost Explorer, and resource rightsizing. Covers EC2 rightsizing, idle resource
  detection, Savings Plan and Reserved Instance recommendations, and cost
  anomaly detection. Use when optimizing AWS infrastructure costs with native
  AWS tools.
connection_type: aws
preload: false
---
