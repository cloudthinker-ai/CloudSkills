...
description: |
  GitHub deep platform management covering repository inventory, branch protection analysis, Actions workflow monitoring, security alerts, dependency graph, code scanning results, organization member auditing, and webhook management. Use when auditing repository configurations, investigating CI/CD failures, reviewing security posture, or managing organization-wide settings.
