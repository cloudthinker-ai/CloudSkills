...
description: |
  Kibana visualization platform with space management, saved objects, index patterns, dashboard export, and lens analysis. Covers dashboard management, visualization listing, data view configuration, alerting rules, and reporting. Use when managing Kibana spaces, exporting dashboards, reviewing index patterns, or analyzing saved objects via API.
