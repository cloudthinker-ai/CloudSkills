...
description: |
  Use when working with Papertrail — papertrail cloud-hosted log management for
  log aggregation, search, tail, alerting, and archiving. Covers log searching,
  system and group management, saved search alerts, and log volume analysis. Use
  when searching Papertrail logs, investigating incidents via log data, managing
  log groups and systems, or configuring log-based alerts.
