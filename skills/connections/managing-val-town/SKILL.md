...
description: |
  Val Town platform management covering val inventory, execution logs, scheduled val status, HTTP endpoint configuration, email handler analysis, blob storage usage, and usage metrics. Use for comprehensive Val Town workspace assessment and optimization.
