...
description: |
  Passage by 1Password passwordless authentication management covering users, devices, WebAuthn credentials, and app configuration. Use when analyzing passkey adoption, monitoring user authentication health, reviewing device registrations, managing Passage users, or auditing passwordless login activity.
