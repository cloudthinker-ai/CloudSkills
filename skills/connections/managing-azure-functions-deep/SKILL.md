...
description: |
  Deep Azure Functions analysis covering function app inventory, trigger types, execution metrics, scaling behavior, slot deployments, application insights integration, and consumption plan cost tracking. Provides optimization guidance for cold starts and memory usage.
