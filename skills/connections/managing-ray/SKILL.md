...
name: managing-ray
description: |
  Ray distributed computing platform management. Covers cluster management, job submission, Ray Serve deployment, dashboard monitoring, actor management, and resource utilization. Use when managing distributed ML workloads, deploying model serving, investigating job failures, or monitoring Ray cluster health.
connection_type: ray
preload: false
---
