...
name: managing-coveo
description: |
  Coveo enterprise search platform management including sources, indexes, query pipelines, machine learning models, usage analytics, and security providers. Covers indexing health, query performance, ML model status, content freshness, and license utilization.
