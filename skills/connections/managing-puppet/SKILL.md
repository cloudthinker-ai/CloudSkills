...
description: |
  Use when working with Puppet — puppet configuration management. Covers catalog
  compilation, node management, module installation, report analysis, fact
  inspection, environment management, and resource auditing. Use when managing
  Puppet infrastructure, debugging catalog failures, inspecting node states, or
