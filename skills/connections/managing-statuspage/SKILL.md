...
description: |
  Use when working with Statuspage — statuspage.io component management,
  incident lifecycle, scheduled maintenance, metric publishing, and subscriber
  notifications. Covers component status updates, incident creation and
  resolution, uptime metrics, and page configuration. Use when managing status
  page components, creating incidents, publishing metrics, or reviewing
  subscriber status via API.
