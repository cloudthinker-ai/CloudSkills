...
enabled: true
description: |
  Use when performing canary deployment — canary deployment template covering
  traffic percentage ramp-up, metrics gates at each stage, automated promotion
  criteria, and rollback triggers. Use for gradual, risk-controlled production
  releases with real traffic validation.
