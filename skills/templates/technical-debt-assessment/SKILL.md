...
enabled: true
description: |
  Template for systematically identifying, categorizing, and prioritizing technical debt across a codebase or system. Covers code quality metrics, architecture smells, dependency risks, test coverage gaps, and creates a prioritized remediation backlog with business impact analysis.
