...
enabled: true
description: |
  Defines a structured war room protocol for managing major incidents, including role assignments, communication cadences, escalation paths, and decision-making frameworks. This template helps teams respond to critical incidents efficiently by establishing clear procedures before they are needed.
