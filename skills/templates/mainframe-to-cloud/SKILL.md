...
enabled: true
description: |
  Provides a structured methodology for migrating mainframe workloads (COBOL, JCL, CICS, IMS) to cloud-native platforms. Covers code analysis, automated conversion, data migration from hierarchical and VSAM stores, batch job modernization, and phased cutover with parallel validation.
