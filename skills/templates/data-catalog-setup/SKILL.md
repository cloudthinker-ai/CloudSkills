...
enabled: true
description: |
  Use when performing data catalog setup — guides the setup and implementation
  of a data catalog to enable data discovery, documentation, lineage tracking,
  and governance. Covers tool selection, metadata extraction, automated
  cataloging, ownership assignment, and adoption strategies for driving
