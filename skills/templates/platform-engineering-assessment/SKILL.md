...
enabled: true
description: |
  Use when performing platform engineering assessment — assesses the maturity
  and effectiveness of an organization's internal developer platform (IDP).
  Covers self-service capabilities, developer experience, golden paths, platform
  team structure, adoption metrics, and roadmap for building a platform that
