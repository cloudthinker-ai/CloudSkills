...
enabled: true
description: |
  DNS-specific incident response playbook covering DNS resolution failures, propagation issues, DNSSEC validation errors, DNS provider outages, and misconfiguration recovery. Provides diagnostic commands, TTL-aware recovery timelines, failover procedures, and DNS health verification steps.
