...
enabled: true
description: |
  Audits the state of technical documentation across an engineering organization. Covers documentation inventory, freshness assessment, gap identification, quality scoring, ownership assignment, and a remediation plan to achieve comprehensive, accurate, and maintainable documentation.
