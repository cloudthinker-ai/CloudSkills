...
enabled: true
description: |
  Template for assessing data pipeline quality, reliability, and data integrity. Covers schema validation, data freshness monitoring, completeness checks, anomaly detection, lineage tracking, and SLA compliance to ensure trustworthy data flows from source to consumption.
