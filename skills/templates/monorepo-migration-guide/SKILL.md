...
enabled: true
description: |
  Step-by-step guide for migrating from multiple repositories to a monorepo structure. Covers repository consolidation strategy, history preservation, build system selection, CI/CD reconfiguration, code ownership setup, and dependency management to enable a successful monorepo transition.
