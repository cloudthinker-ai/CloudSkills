...
enabled: true
description: |
  Use when performing dns cutover runbook — dNS cutover procedure covering
  pre-checks, TTL reduction, cutover execution, validation, and rollback. Use
  for domain migrations, CDN changes, load balancer swaps, or any DNS-dependent
