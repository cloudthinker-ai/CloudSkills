...
enabled: true
description: |
  Guides the creation of comprehensive data flow diagrams (DFDs) that map how data moves through a system, identifying sources, destinations, transformations, and storage points. This template supports privacy reviews, security assessments, and compliance documentation by producing clear data lineage artifacts.
