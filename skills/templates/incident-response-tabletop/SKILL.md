...
enabled: true
description: |
  Use when performing incident response tabletop — plans and facilitates a
  tabletop exercise to test incident response procedures without impacting
  production systems. Covers scenario design, participant preparation, exercise
  facilitation, response evaluation, and after-action review to identify gaps in
  incident readiness.
