...
enabled: true
description: |
  Template for configuring and validating log rotation policies across services and infrastructure. Covers log volume assessment, rotation strategy selection, retention policy configuration, compression settings, and monitoring to prevent disk exhaustion and ensure compliance with retention requirements.
