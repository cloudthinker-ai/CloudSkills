...
enabled: true
description: |
  Template for defining, measuring, and enforcing performance budgets across web applications and services. Covers Core Web Vitals targets, bundle size limits, API latency thresholds, resource loading budgets, and regression detection to maintain fast user experiences.
