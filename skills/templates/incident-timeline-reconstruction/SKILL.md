...
enabled: true
description: |
  Post-incident timeline building framework for reconstructing the sequence of events from logs, alerts, chat messages, deployment records, and monitoring data. Provides structured approaches to gathering evidence, correlating timestamps, identifying gaps, and producing an authoritative incident timeline for postmortem analysis.
