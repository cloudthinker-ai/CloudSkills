...
enabled: true
description: |
  Use when performing cpu profiling guide — guides systematic CPU profiling to
  identify and resolve CPU-bound performance bottlenecks. Covers profiler
  selection and setup, flame graph analysis, hot path identification,
  optimization strategies, and validation procedures for common language
  runtimes.
