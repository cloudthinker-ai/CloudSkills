...
enabled: true
description: |
  Use when performing etl pipeline review — reviews ETL/ELT pipeline
  architecture for reliability, performance, data quality, and maintainability.
  Covers pipeline design patterns, error handling, idempotency, monitoring,
  testing strategies, and optimization opportunities for batch and streaming
  data pipelines.
