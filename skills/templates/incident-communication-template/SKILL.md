...
enabled: true
description: |
  Use when performing incident communication template — template for structured
  incident communications across all stages of an incident lifecycle. Covers
  initial notification, status updates, resolution announcement, and
  post-incident summary with audience-specific messaging for internal teams,
  leadership, customers, and public status pages.
