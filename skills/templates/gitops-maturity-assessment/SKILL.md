...
enabled: true
description: |
  Use when performing gitops maturity assessment — assesses an organization's
  GitOps adoption maturity across declarative configuration, version control
  practices, automated reconciliation, and observability. Evaluates adherence to
  GitOps principles and produces a roadmap for advancing to a fully automated,
  Git-driven operations model.
