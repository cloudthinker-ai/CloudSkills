...
enabled: true
description: |
  Template for defining and implementing API versioning strategies. Covers versioning scheme selection, backward compatibility analysis, migration path design, client communication planning, and deprecation timelines to manage API evolution without breaking existing consumers.
