...
enabled: true
description: |
  Regulatory compliance code review template covering SOC 2, HIPAA, PCI DSS, and GDPR requirements. Evaluates code changes for data handling compliance, audit logging, access controls, encryption standards, and data retention policies to ensure regulatory requirements are met in code.
