...
enabled: true
description: |
  Runs a focused sprint to identify and eliminate cloud resource waste. Covers idle resource detection, rightsizing opportunities, orphaned resource cleanup, storage optimization, and quick-win cost reductions that can be implemented within days rather than weeks.
