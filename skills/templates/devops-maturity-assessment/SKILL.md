...
enabled: true
description: |
  Assesses an organization's DevOps maturity across key dimensions including culture, automation, measurement, and sharing (CALMS). Produces a current maturity score, identifies improvement areas, and generates a prioritized roadmap for advancing DevOps practices.
