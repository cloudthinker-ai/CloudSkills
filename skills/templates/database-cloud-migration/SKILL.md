...
enabled: true
description: |
  Use when performing database cloud migration — guides the migration of
  databases to cloud-managed services, covering schema compatibility analysis,
  data transfer methods, replication setup, cutover procedures, and
  post-migration validation. Supports relational, NoSQL, and data warehouse
  migrations with minimal data loss risk.
